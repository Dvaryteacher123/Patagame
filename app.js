...
async function loadUsersStats() {
    try {
        ...
        const statsTotal = document.querySelector('.hero-stat .stat-number');
        if (statsTotal) {
            document.querySelectorAll('.hero-stat .stat-number')[0].textContent = allGames.length || 0;
            document.querySelectorAll('.hero-stat .stat-number')[1].textContent = total || 0;
            document.querySelectorAll('.hero-stat .stat-number')[2].textContent = online || 0;
        }
